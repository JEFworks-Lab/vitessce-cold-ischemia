  ...
  return (
    <>
      ...
      <section className="abstract-authors" id="abstract-authors">
        <p>
          <strong>Abstract:</strong> Kidney transplantation is the preferred treatment strategy for end-stage kidney disease. Deceased donor kidneys usually undergo cold storage until kidney transplantation, leading to cold ischemia injury that may contribute to poor graft outcomes. However, the molecular characterization of potential mechanisms of cold ischemia injury remains incomplete. To bridge this knowledge gap, we leveraged the 10X Visium spatial transcriptomic technology to perform full transcriptome profiling of murine kidneys subject to varying durations of cold ischemia typical in a deceased donor kidney transplant setting. We developed a computational workflow to identify and compare spatiotemporal transcriptomic changes that accompany the injury pathophysiology in a tissue compartment-specific manner. We identified upregulation of oxidative phosphorylation (OXPHOS) genes increasing duration of cold ischemia injury within the oxygen-lean inner medulla region typically considered to prefer glycolytic pathway. Interestingly, this upregulation of OXPHOS was found to be distinct in cold ischemia injury tissue compared to warm ischemia-reperfusion kidney injury tissue. These spatiotemporal trends were validated by qPCR and immunofluorescence in a larger cohort of mice animals. Altogether, our spatiotemporal transcriptomic analysis identified molecular changes deep within the cold ischemic kidney, highlighting the need for increased attention to the inner medulla and potential opportunities for new insights beyond those available from superficial biopsy-focused tissue examinations. 
          <br /><br />
